...
public class UserController {
    ...
    public ResponseEntity<?> createUsers(
        ...
        if (userService.findById(realm, storage, user.getUsername()) == null) {
            ...
            URI location = ServletUriComponentsBuilder.fromCurrentRequest().path("/" + user.getUsername()).build()
                    .toUri();
            return ResponseEntity.created(location).body(userService.findById(realm, storage, user.getUsername()));
        } else {
    ...
    public ResponseEntity<?> updateUsers(
        ...
        return updateUsers(realm, foundUser.getUserStorage(), id, user);
    }
    ...
    public ResponseEntity<String> deleteUsers(
        ...
        User foundUser = userService.findById(realm, null, id);
        return deleteUsers(realm, foundUser.getUserStorage(), id);
    }
