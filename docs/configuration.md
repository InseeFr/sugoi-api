...
| fr.insee.sugoi.jms.queue.requests.name            |                                                              Name of the queue where the JmsWriter writes request and where a receiver read the request to process.                                                              |          none |          queue.sugoi.developpement.requests |
| fr.insee.sugoi.jms.queue.response.name            |                                                            Name of the queue where the JmsWriter read a response writes request and where a receiver send a response.                                                            |          none |          queue.sugoi.developpement.response |
