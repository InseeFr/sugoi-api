...
public class ContactGroupeDomaineController {
  ...
  public ResponseEntity<?> getGroups(@PathVariable("id") String identifiant, @PathVariable("domaine") String domaine) {
    return null;
  }
  ...
  public ResponseEntity<?> addToGroup(@PathVariable("id") String identifiant, @PathVariable("domaine") String domaine,
      @PathVariable("nomappli") String nomAppli, @PathVariable("nomgroupe") String nomGroupe) {
    return null;
  }
