...
public enum LdapConfigKeys implements RealmConfigKeys {
  ...
  ORGANIZATION_DN_PATTERN("organization_dn_pattern"),
  USER_DN_PATTERN("user_dn_pattern"),
  ADDRESS_DN_PATTERN("address_dn_pattern"),
  GROUP_DN_PATTERN("group_dn_pattern"),
  APPLICATION_DN_PATTERN("application_dn_pattern"),
