package fr.insee.sugoi.config.fixtures;
...
public class StoreMappingFixture {
    ...
    public static List<StoreMapping> getUserStoreMappings() {
        ...
        mapping.add(new StoreMapping("attributes.personal_title", "personalTitle", ModelType.STRING, true));
        mapping.add(new StoreMapping("attributes.description", "description", ModelType.STRING, true));
        mapping.add(new StoreMapping("attributes.phone_number", "telephoneNumber", ModelType.STRING, true));
        mapping.add(new StoreMapping("habilitations", "inseeGroupeDefaut", ModelType.LIST_HABILITATION, true));
        mapping.add(new StoreMapping("organization", "inseeOrganisationDN", ModelType.ORGANIZATION, true));
        ...
        mapping.add(new StoreMapping("attributes.insee_roles_applicatifs", "inseeRoleApplicatif", ModelType.LIST_STRING, true));
        mapping.add(new StoreMapping("attributes.hasPassword", "userPassword", ModelType.EXISTS, false));
        mapping.add(new StoreMapping("metadatas.modifyTimestamp", "modifyTimestamp", ModelType.STRING, false));
        return mapping;
    }
